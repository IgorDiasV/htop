#############################################################################
# Makefile for building: htop
# Generated by qmake (3.1) (Qt 5.15.2)
# Project:  htop.pro
# Template: app
# Command: /home/igor/Qt/5.15.2/gcc_64/bin/qmake -o Makefile htop.pro -spec linux-g++ CONFIG+=debug
#############################################################################
...
QMAKE         = /home/igor/Qt/5.15.2/gcc_64/bin/qmake
DEL_FILE      = rm -f
...
INSTALL_DIR   = cp -f -R
QINSTALL      = /home/igor/Qt/5.15.2/gcc_64/bin/qmake -install qinstall
QINSTALL_PROGRAM = /home/igor/Qt/5.15.2/gcc_64/bin/qmake -install qinstall -exe
DEL_FILE      = rm -f
SYMLINK       = ln -f -s
DEL_DIR       = rmdir
MOVE          = mv -f
...
COMPRESS      = gzip -9f
DISTNAME      = htop1.0.0
DISTDIR = /home/igor/str/htop/.tmp/htop1.0.0
LINK          = g++
LFLAGS        = -Wl,-rpath,/home/igor/Qt/5.15.2/gcc_64/lib
LIBS          = $(SUBLIBS) /home/igor/Qt/5.15.2/gcc_64/lib/libQt5Widgets.so /home/igor/Qt/5.15.2/gcc_64/lib/libQt5Gui.so /home/igor/Qt/5.15.2/gcc_64/lib/libQt5Core.so -lGL -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = ../../Qt/5.15.2/gcc_64/mkspecs/features/spec_pre.prf \
		...
		htop.pro mainwindow.h main.cpp \
		mainwindow.cpp
QMAKE_TARGET  = htop
DESTDIR       = 
TARGET        = htop
...
htop: ui_mainwindow.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: htop.pro ../../Qt/5.15.2/gcc_64/mkspecs/linux-g++/qmake.conf ../../Qt/5.15.2/gcc_64/mkspecs/features/spec_pre.prf \
		../../Qt/5.15.2/gcc_64/mkspecs/common/unix.conf \
		../../Qt/5.15.2/gcc_64/mkspecs/common/linux.conf \
		../../Qt/5.15.2/gcc_64/mkspecs/common/sanitize.conf \
		../../Qt/5.15.2/gcc_64/mkspecs/common/gcc-base.conf \
		...
		../../Qt/5.15.2/gcc_64/mkspecs/features/lex.prf \
		htop.pro
	$(QMAKE) -o Makefile htop.pro -spec linux-g++ CONFIG+=debug
...
moc_mainwindow.cpp: mainwindow.h \
	...
	/home/igor/Qt/5.15.2/gcc_64/bin/moc $(DEFINES) --include /home/igor/str/htop/moc_predefs.h -I/home/igor/Qt/5.15.2/gcc_64/mkspecs/linux-g++ -I/home/igor/str/htop -I/home/igor/Qt/5.15.2/gcc_64/include -I/home/igor/Qt/5.15.2/gcc_64/include/QtWidgets -I/home/igor/Qt/5.15.2/gcc_64/include/QtGui -I/home/igor/Qt/5.15.2/gcc_64/include/QtCore -I/usr/include/c++/9 -I/usr/include/x86_64-linux-gnu/c++/9 -I/usr/include/c++/9/backward -I/usr/lib/gcc/x86_64-linux-gnu/9/include -I/usr/local/include -I/usr/include/x86_64-linux-gnu -I/usr/include mainwindow.h -o moc_mainwindow.cpp
...
ui_mainwindow.h: mainwindow.ui \
	...
	/home/igor/Qt/5.15.2/gcc_64/bin/uic mainwindow.ui -o ui_mainwindow.h
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/htop/bin || mkdir -p $(INSTALL_ROOT)/opt/htop/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/htop/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/htop/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/htop/bin/ 
